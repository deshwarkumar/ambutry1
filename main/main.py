...
SERIAL_PORT = 'COM11'  # Update to your port
BAUD_RATE = 9600
TELEGRAM_TOKEN = '7970513032:AAHBR6Wigyq8V-n5p0jdcRJWhjV5wCft2r4'
CHAT_ID = 5430423218  # Your Telegram chat ID
MAP_FILE = "map.html"
map_opened = False
SAVE_FOLDER = "saved_images"  # Folder to save images
os.makedirs(SAVE_FOLDER, exist_ok=True)  # Create if it doesn't exist
# Four predefined destination coordinates (latitude, longitude)
DESTINATIONS = [
    (12.9716, 77.5946),
    (17.4050, 78.4700),
    (14.6500, 77.5300),
...
# === Map updater using nearest location logic ===
def update_google_maps_to_nearest(start_lat, start_lon):
    ...
    <body>
        ...
        <p>If you are not redirected, <a href="{directions_url}">click here</a>.</p>
    </body>
    </html>
    """
